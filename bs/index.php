...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                <a class="navbar-brand" href="#!">E-SPP</a>
                    ...
                    <div class="col-xl-7">
                        <div class="text-center text-white">
                            ...
                            <form class="form-subscribe" id="contactForm" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input class="form-control form-control-lg" id="nis" type="id" placeholder="Masukkan NIS di sini" data-sb-validations="required,email" />
